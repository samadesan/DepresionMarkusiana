...
--
-- Servidor: localhost
-- Tiempo de generación: 02-04-2026 a las 16:42:30
...
INSERT INTO `canciones` (`id`, `disco_id`, `titulo`, `archivo_mp3`, `orden`, `duracion_track`) VALUES
(1, 1, 'Hay que abandonar este lugar', '01_abandonar.mp3', 1, '3:15'),
(2, 1, 'Ya no hay ganas de bailar', '02_ganas.mp3', 2, '3:40');

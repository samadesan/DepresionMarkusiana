...
?>
    ...
    <main class="py-5" id="main-wrapper">
        <div class="align-items-center">
            <h2 class="display-4 fw-bold mb-5 titulo-centrado">DISCOGRAFÍA</h2>
            <div class="row g-3" id="discoContainer" style="display: flex; justify-content: center;">
                <div class="row g-2">
                    <div class="col-md-3">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 disco-item reveal"
                        ...
                        <div class="card bg-transparent border-secondary rounded-0 h-100 album-card">
                            <div class="position-relative overflow-hidden">
                                <img src="assets/media/img/discografia/<?php echo $d['portada_url']; ?>" class="card-img-top rounded-0 grayscale" alt="...">
